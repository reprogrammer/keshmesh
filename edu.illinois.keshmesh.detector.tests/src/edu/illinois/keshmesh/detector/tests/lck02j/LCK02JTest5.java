...
public class LCK02JTest5 extends LCK02JTest {
	...
	public void shouldFindLCK02J() throws WALAInitializationException {
		...
		//Linux:
		Assert.assertTrue(bugInstances.contains(new BugInstance(BugPatterns.LCK02J, new BugPosition(417, 447, targetTestClassPath), new LCK02JFixInformation(SetUtils.asSet("p.Test.C.class",
				"p.Test.D.class")))));
