...
public class LCK02JTest3 extends LCK02JTest {
	...
	public void setup() throws Exception {
		setupProjectAndAnalyze("test-files/LCK02J/03/Test.java");
	}

	@Test
	public void shouldFindLCK02J() {
		Assert.assertEquals(1, bugInstances.size());
		Assert.assertTrue(bugInstances.contains(new BugInstance(BugPatterns.LCK02J, new BugPosition(20, 22, targetTestClassPath), new LCK02JFixInformation(SetUtils.asSet("p.Test.C.class")))));
	}
}
